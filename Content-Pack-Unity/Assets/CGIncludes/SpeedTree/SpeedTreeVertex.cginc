...
// - Use a modified version of SpeedTreeWind.
// - Add global variable _MaxWindQuality for gfx settings.
...
uniform half _MaxWindQuality;

#include "Assets/CGIncludes/SpeedTree/SpeedTreeWind.cginc"
...
void OffsetSpeedTreeVertex(inout SpeedTreeVB data, float lodValue)
{
    ...
    #ifdef ENABLE_WIND
        half windQuality = _MaxWindQuality;//min(_WindQuality * _WindEnabled, _MaxWindQuality);
