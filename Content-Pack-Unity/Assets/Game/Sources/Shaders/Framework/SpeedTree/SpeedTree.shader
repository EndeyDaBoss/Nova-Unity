...
// Adjusted for Unturned to:
// - Rename to Framework/SpeedTree.
// - Use modified version of SpeedTreeCommon.
// - Replace #define ENABLE_WIND with multi_compile ENABLE_WIND so that it can be a gfx option.

Shader "Framework/SpeedTree"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #pragma target 3.0
            #pragma multi_compile_vertex  LOD_FADE_PERCENTAGE ENABLE_WIND
            ...
            #include "Assets/CGIncludes/SpeedTree/SpeedTreeCommon.cginc"
        ...
        Pass
        {
            ...
            CGPROGRAM
                ...
                #pragma target 3.0
                #pragma multi_compile_vertex  LOD_FADE_PERCENTAGE LOD_FADE_CROSSFADE ENABLE_WIND
