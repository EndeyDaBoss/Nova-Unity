...
// - Rename to Framework/SpeedTree Billboard.
// - Use modified version of SpeedTreeBillboardCommon.
// - Replace #define ENABLE_WIND with multi_compile ENABLE_WIND so that it can be a gfx option.

Shader "Framework/SpeedTree Billboard"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
            ...
            #pragma target 3.0
			#pragma multi_compile_vertex ENABLE_WIND
            #pragma multi_compile __ BILLBOARD_FACE_CAMERA_POS
            #pragma shader_feature EFFECT_BUMP
            #pragma shader_feature EFFECT_HUE_VARIATION
            #include "Assets/CGIncludes/SpeedTree/SpeedTreeBillboardCommon.cginc"
